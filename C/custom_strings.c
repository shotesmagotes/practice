// THIS PROGRAM IS TO DEMONSTRATE AN EXAMPLE IMPEMENTATION OF THERE STRING FUNCTIONS FROM THE
// <STRING.H> LIBRARY IN THE C STANDARD. IT IS SIMPLY USED TO DEMONSTRATE POINTER ARITHMETIC
